...
for idx, dataset in enumerate(st.session_state.my_datasets):
    if category_filter == "All" or category_filter == dataset['category']:
        with cols[idx % 2]:
            ...
            paypal_link = f"https://www.paypal.com/cgi-bin/webscr?cmd=_xclick&business=09manongsongken@gmail.com&item_name={dataset['name']}&amount={dataset['price']}&currency_code=USD"
